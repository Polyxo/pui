# @progressiveui/pictograms-react
...
To install `@progressiveui/pictograms-react` in your project, you will need to run the
following command using [npm](https://www.npmjs.com/):

```bash
npm install -S @progressiveui/pictograms-react
```
...
```bash
yarn add @progressiveui/pictograms-react
```
...
```jsx
import { SdgLogo } from "@progressiveui/pictograms-react";
```
...
```js
const { Airplane } = require("@progressiveui/pictograms-react");
```
...
```jsx
import { Airplane } from "@progressiveui/pictograms-react";
...
By default, the icon components from `@progressiveui/pictograms-react` are treated as
