...
import tokens from "@progressiveui/themes-core/dist/json/variables-full";
...
corresponding to the corporate blue: it is used for brand elements and
...
<h4 className="wfp--story__sub-heading">Corporate colour</h4>

The brand-01 colour corporate blue which is used in all
...
is slightly lighter then the main blue to communicate that an element is
...
#### Use $action-default-fill-primary-default for:
...
import colors from "@progressiveui/react/src/globals/data/colors.json";

// Import colours as js
import colors from "@progressiveui/react/src/globals/data/colors.js";
