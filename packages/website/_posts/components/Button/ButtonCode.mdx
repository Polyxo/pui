...
<>
  {buttonKinds
    .filter(
      (e) =>
        e === "primary" || e === "secondary" || e === "ghost" || e === "danger"
    )
    .map((e) => (
      <div
        style={{
...
<>
  ...
  <Button kind="secondary" icon={AddCircle}></Button> <Button
    iconReverse
    kind="secondary"
    icon={AddCircle}
  >
    ...
    Icon link
  </Button> <Button href="#" kind="secondary" icon={AddCircle}></Button>{" "}
  <Button href="#" iconReverse kind="secondary" icon={AddCircle}>
    IconReverse link
  </Button>
</>
```
