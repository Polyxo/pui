...
category: "Core"
title: "Notification"
excerpt: "Notifications provide information about status changes, errors, or other important information that requires user attention."
...
componentsNew:
  ToastNotification:
    path: "Notification/ToastNotification"
---
