---
title: "Usage"
excerpt: "This is how to implement the design tokens in your project."
coverImage: "../sample-image.jpg"
slug: "tokens/Use(Developer)"
...
```css
@use "@progressiveui/themes-core/dist/scss/tokensMapDeep" as tokensMapDeep;
```
...
```css
@use "@progressiveui/themes-core/dist/scss/tokensMapFlat" as tokensMapFlat;
```
